 ...
 *      Params '$storeSettingsDirectory' and '$adminSettingsFile' are defined in services.yaml
 */
final class AdminSettings
{
    ...
    public function __construct(string $storeSettingsDirectory, string $adminSettingsFile,
