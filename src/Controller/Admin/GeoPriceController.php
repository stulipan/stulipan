...
class GeoPriceController extends BaseController
{
    ...
    public function apiGetCitiesBy(Request $request)
    {
        ...
        if ($cities) {
            return $this->jsonNormalized(['cities' => $cities], 200);
        } else {
    ...
    public function apiGetCity(Request $request)
    {
        ...
        if ($city) {
            return $this->jsonNormalized($city);
        } else {
    ...
    public function apiGetProvinces(Request $request)
    {
        ...
        if ($provinces) {
            return $this->jsonNormalized(['provinces' => $provinces]);
        } else {
...
//            'form' => $form->createView(),
    ...
    public function apiCreateGeoPrice(Request $request, ValidatorInterface $validator)
    {
        ...
        return $this->jsonNormalized(['geoPrices' => $geoPriceList], 200);
    }
