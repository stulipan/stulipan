 ...
 */
class CheckoutSettingsController extends AbstractController
{
    ...
    public function editSettings(Request $request, StoreSettings $settings, string $settingsDirectory, string $checkoutSettingsFile)
    {
        ...
        if (count($locatedFile) === 1) {
            ...
            throw new Error( sprintf('HIBA: Multiple %s files were found. Make sure you have only one %s file in your %s folder!', $storeSettingsFile, $storeSettingsDirectory));
        }
